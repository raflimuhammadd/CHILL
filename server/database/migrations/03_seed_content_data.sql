-- ============================================================================
-- SEED CONTENT DATA
-- Description: Content catalog, episodes, genres mapping, recommendations
-- Generated from client/src/data/filmData.js
-- Requires: genres seeded (ids 1-15), 02_seed_master_data.sql
-- ============================================================================

-- ----------------------------------------------------------------------------
-- CONTENTS (46 films/series)
-- ----------------------------------------------------------------------------
...
INSERT INTO contents (content_type, title, slug, description, release_year, age_rating, total_episodes, duration_minutes, youtube_id, poster_url, banner_url, cast, creator, rating, is_premium_only) VALUES
  ...
  ('movie', 'MEGAN', 'megan', 'Seorang insinyur robotika menjadi wali bagi keponakannya yang yatim piatu. Ia menciptakan sebuah boneka AI yang disebut M3GAN untuk menemani dan melindungi gadis itu. Namun M3GAN menjadi terlalu protektif dengan caranya yang mengerikan.', 2022, '13+', NULL, 102, 'jGmZLGbcCY8', '/assets/images/megan.png', '/assets/images/megan-lands.png', 'Allison Williams, Violet McGraw, Amie Donald, Jenna Davis, Ronny Chieng', 'Gerard Johnstone', 4.5, 0),
  ...
  ('movie', 'Suzume', 'suzume', 'Suzume, seorang gadis SMA, bertemu dengan seorang pemuda yang mencari pintu misterius. Ia mengikuti pemuda itu dan secara tidak sengaja membuka pintu yang melepaskan bencana ke Jepang. Suzume harus berlari melintasi Jepang untuk menutup pintu-pintu itu.', 2023, '7+', NULL, 122, 'KlnIuIVftaU', '/assets/images/suzume.png', '/assets/images/suzame-lands.png', 'Nanoka Hara, Hokuto Matsumura, Eri Fukatsu, Sōta Fukushi', 'Makoto Shinkai', 4.5, 0),
  ('series', 'Light Shop', 'light-shop', 'Kisah sekelompok orang asing yang memiliki pengalaman buruk dari masa lalunya. Mereka tertarik ke toko lampu misterius di ujung gang gelap.', 2024, '17+', 8, NULL, 'jSj4SOdLA3A', '/assets/images/light-shop-portrait.jpg', '/assets/images/light-shop-land.jpg', 'Ju Ji-hoon, Park Bo-young, Bae Seong-woo, Uhm Tae-goo, Lee Jung-eun, Kim Min-ha', 'Kang Full', 4.5, 0),
  ...
  ('movie', 'The Amazing Spider-Man', 'amazing-spidey', 'Peter Parker, seorang remaja SMA yang cerdas, mendapatkan kekuatan seperti laba-laba setelah digigit laba-laba hasil rekayasa genetika. Ia belajar bahwa dengan kekuatan besar datang tanggung jawab besar, saat ia berhadapan dengan The Lizard.', 2012, '13+', NULL, 122, 'cjq5-zmIpWA', '/assets/images/amazng-spidey-prtrt.jpg', '/assets/images/amazing-spidey-lands.jpg', 'Andrew Garfield, Emma Stone, Rhys Ifans, Denis Leary, Sally Field', 'Marc Webb', 4.6, 1),
...
-- ----------------------------------------------------------------------------
-- CONTENT_GENRES (Many-to-many mapping)
-- ----------------------------------------------------------------------------
